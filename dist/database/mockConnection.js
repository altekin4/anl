...
class MockDatabaseConnection {
    constructor() {
        ...
        this.connected = true;
        logger_1.default.info('Mock database connection initialized');
    }
    async query(text, params) {
        logger_1.default.info('Mock query executed:', { text: text.substring(0, 100) + '...', params });
    ...
    async close() {
        this.connected = false;
        logger_1.default.info('Mock database connection closed');
    }
    getPool() {
    ...
    async runMigrations() {
        logger_1.default.info('Mock migrations completed (no actual migrations run)');
    }
}
exports.mockDb = new MockDatabaseConnection();
